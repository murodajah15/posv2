...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-approv_batas_piutang"
                            class="table table-bordered table-hover table-sm tbl-approv_batas_piutang">
                            {{-- <table id="tbl-approv_batas_piutang" class="table table-bordered table-striped tbl-approv_batas_piutang"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="90">No.Approval</th>
                            ...
                            <tbody>
                                {{-- @foreach ($approv_batas_piutang as $row)
                                    <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-approv_batas_piutang').DataTable({
                    ajax: "{{ route('approv_batas_piutangajax') }}",
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.noapprov}</a>`;
                            }
                        },
                        {
                            data: 'tglapprov',
        ...
        function reload_table1() {
            $(document).ready(function() {
                $('#tbl-approv_batas_piutang-data').DataTable({
                    // "destroy": true,
                    "aLengthMenu": [
                        [5, 50, 100, -1],
                        [5, 50, 100, "All"]
            ...
            $.ajax({
                url: "<?= 'tabel_approv_batas_piutang' ?>",
                beforeSend: function(f) {
                    $('.btnreload').attr('disable', 'disabled')
                    $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
                    // alert('1');
                    $('#tabel_approv_batas_piutang').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_approv_batas_piutang').html(data);
        ...
        $('.tomboltambah').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: `{{ route('approv_batas_piutang.create') }}`,
                dataType: "json",
        ...
        function detail(id) {
            $.ajax({
                type: "get",
                url: `{{ url('approv_batas_piutang') }}/${id}`,
                dataType: "json",
                data: {
                    id: id,
                    _method: "GET",
        ...
        function edit(id) {
            $.ajax({
                type: "get",
                url: `{{ url('approv_batas_piutang') }}/${id}/edit`,
                dataType: "json",
                data: {
                    id: id,
                    _method: "GET",
        ...
        function proses(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: `{{ url('approv_batas_piutangproses') }}/${id}`,
                            type: "POST",
                            data: {
                                id: id,
                                _token: '{{ csrf_token() }}',
        ...
        function unproses(id) {
            ...
            $.ajax({
                type: "get",
                url: `{{ url('approv_batas_piutangbatalproses') }}`,
                dataType: "json",
                data: {
                    id: id,
                    methode: "get",
        ...
        function cancel(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: `{{ url('approv_batas_piutangcancel') }}`,
                            type: "POST",
                            data: {
                                id: id,
                                _token: '{{ csrf_token() }}',
        ...
        function ambil(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: `{{ url('approv_batas_piutangambil') }}`,
                            type: "POST",
                            data: {
                                id: id,
                                _token: '{{ csrf_token() }}',
        ...
        function cetak(id) {
            $url = "{{ url('approv_batas_piutangcetak') }}?id=" + id
