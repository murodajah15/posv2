...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-beli" class="table table-bordered table-hover table-sm tbl-beli">
                            {{-- <table id="so" class="table table-bordered table-striped so"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="100">No.Pembelian</th>
    ...
    <div class="modal fade" id="modalcarigudang" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <div class="modal fade" id="modalcaripo" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <script>
                ...
                var table = $('.tbl-beli').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.nobeli}</a>`;
                            }
                        },
                        {
                            data: 'tglbeli',
                                ...
                                if (row.batal == 'Y') {
                                    ...
                                    if (row.proses == 'Y') {
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <li><a class="dropdown-item <?= $edit == 1 ? '' : 'disabled' ?>" onclick="input_belid(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Detail</a></li>
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    toastr.warning(
                                        'Data gagal di proses (total masih 0), silahkan di cek'
                                    )
                                } else {
                                    reload_table();
        ...
        function input_belid(id) {
            $.ajax({
                type: "get",
                url: `{{ url('beliinputbelid') }}`,
                dataType: "json",
                data: {
                    id: id,
                    methode: "get",
