    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $beli->nobeli . ' - ' . $beli->kdsupplier . ' - ' . $beli->nmsupplier }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="nobelid" id="nobelid" value="{{ $beli->nobeli }}">
            {{-- <div class='col-md-12'> --}}
            <div class="row mb-0">
                <div class="col-sm-6">
                    <div class="btn-group">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class='col-md-12'>
                        <table id='tbl-detail-beli' style='font-size:13px;'
...
<script>
    ...
    function reload_table_detail() {
        $(function() {
            var vnobeli = $("#nobelid").val();
            var table = $('#tbl-detail-beli').DataTable({
