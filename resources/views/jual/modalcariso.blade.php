                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($soh as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_so();">
                                            <?= $row->noso ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_so();">
                                            <?= $row->tglso ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_so();">
...
<script>
    ...
    function post_data_so() {
        ...
        tbody.onclick = function(e) {
            ...
            $('#noso').val(((dt_split[1]).replace("--separator--", "")).trim());
            $('#modalcariso').modal('hide');
        };
    }
</script>
