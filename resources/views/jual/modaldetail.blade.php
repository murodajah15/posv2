    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $jual->nojual . ' - ' . $jual->kdcustomer . ' - ' . $jual->nmcustomer }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="nojuald" id="nojuald" value="{{ $jual->nojual }}">
            {{-- <div class='col-md-12'> --}}
            <div class="row mb-0">
                <div class="col-sm-6">
                    <div class="btn-group">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class='col-md-12'>
                        <table id='tbl-detail-jual' style='font-size:13px;'
...
<script>
    ...
    function reload_table_detail() {
        $(function() {
            var vnojual = $("#nojuald").val();
            var table = $('#tbl-detail-jual').DataTable({
