    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $kasir_tagihan->nokwitansi . ' - ' . $kasir_tagihan->nmcustomer }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class='col-md-12'>
                        <table id='tbl-detail-kasir_tagihan' style='font-size:13px;'
...
<script>
    ...
    function reload_table_detail() {
        $(function() {
            ...
            var table = $('#tbl-detail-kasir_tagihan').DataTable({
    ...
    $('.tomboltambahdetail').click(function(e) {
        ...
        var vnokwitansi = $("#nokwitansid").val();
        $.ajax({
            url: `{{ route('kasir_tagihand.create') }}`,
            dataType: "json",
            data: {
                'nokwitansi': vnokwitansi,
            },
    ...
    function editdetail(id) {
        $.ajax({
            type: "get",
            url: `{{ url('kasir_tagihand') }}/${id}/edit`,
            dataType: "json",
            data: {
                id: id,
                methode: "get",
