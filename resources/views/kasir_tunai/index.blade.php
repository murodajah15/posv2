    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-kasir_tunai" class="table table-bordered table-hover table-sm tbl-kasir_tunai">
                            {{-- <table id="tbl-kasir_tunai" class="table table-bordered table-striped tbl-kasir_tunai"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table1() {
            $(document).ready(function() {
                $('#tbl-kasir_tunai-data').DataTable({
                    // "destroy": true,
                    "aLengthMenu": [
                        [5, 50, 100, -1],
                        [5, 50, 100, "All"]
            ...
            $.ajax({
                url: "<?= 'tabel_kasir_tunai' ?>",
                beforeSend: function(f) {
                    $('.btnreload').attr('disable', 'disabled')
                    $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
                    // alert('1');
                    $('#tabel_kasir_tunai').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_kasir_tunai').html(data);
        ...
        function unproses(id) {
            ...
            $.ajax({
                type: "get",
                url: `{{ url('kasir_tunaibatalproses') }}`,
                dataType: "json",
                data: {
                    id: id,
                    methode: "get",
        ...
        function cetak(id) {
            $url = "{{ url('kasir_tunaicetak') }}?id=" + id
