...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-keluar" class="table table-bordered table-hover table-sm tbl-keluar">
                            {{-- <table id="so" class="table table-bordered table-striped so"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="120">No.Pengeluaran</th>
    ...
    <script>
        ...
        function reload_table() {
            $(function() {
                var table = $('.tbl-keluar').DataTable({
                    ajax: "{{ route('keluarajax') }}",
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.nokeluar}</a>`;
                            }
                        },
                        {
                            data: 'tglkeluar',
                                ...
                                if (row.batal == 'Y') {
                                    ...
                                    if (row.proses == 'Y') {
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <li><a class="dropdown-item <?= $edit == 1 ? '' : 'disabled' ?>" onclick="input_keluard(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Detail</a></li>
        ...
        function input_keluard(id) {
            $.ajax({
                type: "get",
                url: `{{ url('keluarinputkeluard') }}`,
                dataType: "json",
                data: {
                    id: id,
                    methode: "get",
