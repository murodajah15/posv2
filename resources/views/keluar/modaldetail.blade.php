    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $keluar->nokeluar . ' - ' . $keluar->kdsupplier . ' - ' . $keluar->nmsupplier }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class='col-md-12'>
                        <table id='tbl-detail-keluar' style='font-size:13px;'
...
<script>
    ...
    function reload_table_detail() {
        $(function() {
            var vnokeluar = $("#nokeluard").val();
            var table = $('#tbl-detail-keluar').DataTable({
