                    ...
                    <div class="col-lg-12 margin-tb">
                        <table id="tblcari" class="table table-bordered table-hover table-sm">
                            ...
                            <tbody id="isi_data" class="isi_data">
                                <?php $no = 0; ?>
                                @foreach ($mohklruangh as $row)
                                    <?php $no++; ?>
                                    <tr id="tr" style="curpor: pointer; ">
                                        <td style="text-align:center;"><?= $no ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_mohklruangh();">
                                            <?= $row->nomohon ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_mohklruangh();">
                                            <?= $row->tglmohon ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_mohklruangh();">
...
<script>
    ...
    function post_data_mohklruangh() {
        ...
        tbody.onclick = function(e) {
            ...
            $('#nomohon').val(((dt_split[1]).replace("--separator--", "")).trim());
            ...
            $('#modalcarimohklruang').modal('hide');
        };
    }
</script>
