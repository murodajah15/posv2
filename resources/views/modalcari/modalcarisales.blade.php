            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <table id="tblcarisales" class="table table-bordered table-hover table-sm">
                            <thead>
                                <tr>
                                    <th width="5">No</th>
                                    <th width="60">Kode</th>
                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($tbsales as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_sales();">
                                            <?= $row->kode ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_sales();">
                                            <?= $row->nama ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_sales();">
...
<script>
    ...
    function post_data_sales() {
        var table = document.getElementById("tblcarisales");
        ...
        tbody.onclick = function(e) {
            ...
            $('#kdsales').val(((dt_split[1]).replace("--separator--", "")).trim());
            $('#nmsales').val(((dt_split[2]).replace("--separator--", "")).trim());
