                        ...
                        <table id="tblcari" class="table table-bordered table-hover table-sm">
                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($kasir_tagihand as $row)
                                    ...
                                    <tr id="tr" style="curpor: pointer; ">
                                        <td style="text-align:center;"><?= $no ?></td>
                                        <td id="td" data-bs-dismiss="modal"
                                            onclick="post_data_kasir_tagihand();">
                                            <?= $row->nokwitansi ?></td>
                                        <td id="td" data-bs-dismiss="modal"
                                            onclick="post_data_kasir_tagihand();">
                                            <?= $row->tglkwitansi ?></td>
...
<script>
    ...
    function post_data_kasir_tagihand() {
        ...
        tbody.onclick = function(e) {
            ...
            $('#modaltampilpembayaran').modal('hide');
        };
    }

    function post_data_kasir_tunai() {
        var table = document.getElementById("tblcari");
        var tbody = table.getElementsByTagName("tbody")[0];
        tbody.onclick = function(e) {
            e = e || window.event;
