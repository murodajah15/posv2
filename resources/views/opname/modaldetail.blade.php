    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $opname->noopname . ' - ' . $opname->pelaksana }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class='col-md-12'>
                        <table id='tbl-detail-opname' style='font-size:13px;'
...
<script>
    ...
    function reload_table_detail() {
        $(function() {
            var vnoopname = $("#noopnamed").val();
            var table = $('#tbl-detail-opname').DataTable({
