            ...
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <table id="po" class="table table-bordered table-hover table-sm po">
                            {{-- <table id="po" class="table table-bordered table-striped po"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="100">No. PO</th>
                                    <th width="80">Tanggal</th>
                                    <th width="450">Supplier</th>
                ...
                var table = $('.po').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.nopo}</a>`;
                            }
                        },
                        {
                            data: 'tglpo',
                                ...
                                if (row.batal == 'Y') {
                                    ...
                                    if (row.proses == 'Y') {
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <li><a class="dropdown-item <?= $edit == 1 ? '' : 'disabled' ?>" onclick="input_pod(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Detail</a></li>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.sukses === 'Data gagal di cancel') {
                        toastr.warning('Gagal batal proses, po sudah ada penerimaan')
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
