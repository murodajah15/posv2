            ...
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        ?>
                        <font face="calibri">
                            <form method='post' target='_blank' action='rpiutang_xls' class="rpiutang_xls">
                                @csrf
                                <div class="row">
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <input type='checkbox' class='form-checkbox' name='bulanan' id='bulanan'
                                            value='bulanan'>
                                        Bulanan
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <input type='checkbox' class='form-checkbox' name='belumlunas' id='belumlunas'
                                            value='belumlunas' checked>
                                        Belum Lunas
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <input type='checkbox' class='form-checkbox' name='groupingcustomer'
                                            id='groupingcustomer' value='groupingcustomer' checked>
                                        Grouping Customer
                                    </div>
                                </div>
                                <div class='row'>
