...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <table id="tbl-saplikasi" class="table table-bordered table-striped tbl-saplikasi">
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="10">Kode Perusahaan</th>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-saplikasi').DataTable({
                    ajax: "{{ route('saplikasiajax') }}",
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            name: 'kd_perusahaan'
                            // render: function(data, type, row, meta) {
                            //     return `<a href="#" onclick="detail(${row.id})">${row.kd_perusahaan}</a>`;
                            // }
                        },
                        {
                            orderable: true,
