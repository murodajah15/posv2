    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="so" class="table table-bordered table-hover table-sm so">
    ...
    <script>
                ...
                var table = $('.so').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.noso}</a>`;
                            }
                        },
                        {
                            data: 'tglso',
                                    ...
                                    if (row.proses == 'Y') {
                                        return `<div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <li><a class="dropdown-item <?= $cetak == 1 ? '' : 'disabled' ?>"" onclick="cetak(${row.id})" href="#" readonly><i class='fa fa-print'"></i> Cetak</a></li>
                                                <li><a class="dropdown-item <?= $cetak == 1 ? '' : 'disabled' ?>"" onclick="cetakpl(${row.id})" href="#" readonly><i class='fa fa-print'"></i> Cetak Pick List</a></li>
                                            </ul>
                                            </div>`;
                                    } else {
                                        return `<div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <li><a class="dropdown-item <?= $edit == 1 ? '' : 'disabled' ?>" onclick="input_sod(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Detail</a></li>
        ...
        function unproses(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.sukses === 'Data gagal di cancel') {
                        toastr.warning('Gagal batal proses, SO sudah ada penerimaan')
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
        ...
        function cetak(id) {
            $url = "{{ url('socetak') }}?id=" + id
            window.open($url, '_blank')
        }

        function cetakpl(id) {
            $url = "{{ url('socetakpl') }}?id=" + id
            window.open($url, '_blank')
        }
        ...
        function caritbmultiprc() {
            ...
            // var cari = document.getElementById('kdcustomer').value
            $.ajax({
                method: "GET",
        ...
        function hit_subtotal() {
            ...
            var lsubtotal = ldisc;
            document.getElementById('subtotal').value = parseFloat(lsubtotal);
        }
        ...
        function hit_total() {
            ...
            document.getElementById("total_sementara").value = total_sementara
