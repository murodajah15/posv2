    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ $action }}" method="post" class="formeditdetail">
                ...
                @endif
                <?php $tgl = date('Y-m-d'); ?>
                <input type="hidden" class="form-control-sm" name="id" id="id" value="{{ $sod->id }}">
                ...
                <input type="hidden" class="form-control-sm" name="noso" id="noso" value="{{ $so->noso }}">
                <input type="hidden" class="form-control-sm" name="nosod" id="nosod" value="{{ $sod->noso }}">
                <div class='col-md-12'>
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        <tr>
                            <th width="22%">Kode Barang <input type="button" class='btn btn-success btn-sm'
                                    value="Clear" onclick="eraseText()"> <input type="checkbox" class="multiprc"
                                    name="multiprc" id="multiprc" {{ $sod->multiprc == 'Y' ? 'checked' : '' }}> Multi
                                Price</th>
                        ...
                        <td>
                            <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                    ...
                                    size='50' autocomplete='off' value="{{ $sod->kdbarang }}">
                        ...
                        <input type="hidden" id="kdsatuan" name="kdsatuan" value="{{ $sod->kdsatuan }}">
                        </td>
                        <td><input type='text' class='form-control form-control-sm' id='nmbarang' name='nmbarang'
                                value="{{ $sod->nmbarang }}" readonly></td>
                        </td>
                        ...
                        <td><input type="text" class='form-control form-control-sm' id='discount'
                                ...
                                onblur="hit_subtotal()" value="{{ $sod->discount }}">
                        </td>
                        <td><input type="text" class='form-control form-control-sm' id='subtotal'
                                name='subtotal' style='width: 10em;text-align:right;' value="{{ $sod->subtotal }}"
                                readonly></td>
                    </table>
            </form>
            <div class="row">
