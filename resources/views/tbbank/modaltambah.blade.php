...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        @endif --}}
        <form action="{{ $action }}" method="post" class="formtbbank">
            @csrf
            @if ($tbbank->id)
                @method('put')
            @endif
            <div class="modal-body">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="kode" id="kode" value="{{ $tbbank->kode }}"
                ...
                <div class="col-md-12 mb-2">
                    ...
                    <input type="text" class="form-control" name="nama" id="nama" value="{{ $tbbank->nama }}"
                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                    @error('nama')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-md-12 mb-0">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="aktif" name="aktif"
                            {{ (str_contains($vdata['title'], 'Tambah') ? 'checked' : $tbbank->aktif == 'Y') ? 'checked' : '' }}
