    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <div class="btn-group">
                            ...
                            &nbsp;<span><button tipe="button" class="btn btn-primary btn-sm tomboltambah"
                                    ...
                                    Tambah</button></span>
                            {{-- &nbsp;<span><button tipe="button" class="btn btn-warning btn-sm tomboldownload"
                                    {{ $cetak != 1 ? 'disabled' : '' }}> <i class="fa fa-download"></i>
                                    Download</button></span> --}}
                            &nbsp;<span><a href="{{ 'downloadtbbarang' }}"
                                    style="pointer-events: {{ $cetak != 1 ? 'none' : '' }}" class="btn btn-warning btn-sm"
                                    {{ $cetak != 1 ? 'disabled' : '' }}><i class="fa fa-download"></i>
                                    Export Data</a></span>
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-barang" class="table table-bordered table-hover table-sm tbl-barang">
                            {{-- <table id="tbl-barang" class="table table-bordered table-striped tbl-barang"> --}}
                            <thead>
                                <tr>
                ...
                var table = $('.tbl-barang').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: 'harga_beli',
                            render: function(data, type, row, meta) {
                                return meta.settings.fnFormatNumber(row.harga_beli);
                            }
                        },
                        {
                            data: 'harga_jual',
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_barang').html('<center>Loading Table ...</center>');
                },
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    ...
                                    // })
                                    reload_table();
                                    toastr.info('Data berhasil di download, silahkan melanjutkan')
                                    // .then(function() {
                                    //     window.location.href = '/tbbarang';
                                    // });
                                }
