                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($tbnegara as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_negara();">
                                            <?= $row->kode ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_negara();">
                                            <?= $row->nama ?></td>
                                    </tr>
...
<script>
    ...
    function post_data_negara() {
        ...
        tbody.onclick = function(e) {
            ...
            $('#kdnegara').val(((dt_split[1]).replace("--separator--", "")).trim());
            $('#nmnegara').val(((dt_split[2]).replace("--separator--", "")).trim());
