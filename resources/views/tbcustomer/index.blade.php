    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-customer" class="table table-bordered table-hover table-sm tbl-customer">
                            {{-- <table id="tbl-customer" class="table table-bordered table-striped tbl-customer"> --}}
                            <thead>
                                <tr>
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_customer').html('<center>Loading Table ...</center>');
                },
