...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-discount" class="table table-bordered table-hover table-sm tbl-discount">
                            {{-- <table id="tbl-discount" class="table table-bordered table-striped tbl-discount"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-discount').DataTable({
                    ajax: "{{ route('tbdiscountajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_discount').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_discount').html(data);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    ...
                                    // .then(function() {
                                    //     window.location.href = '/tbdiscount';
                                    // });
                                }
                            },
                            error: function(xhr, ajaxOptions, thrownError) {
