...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        <form action="{{ $action }}" method="post" class="formtbdiscount">
            @csrf
            @if ($tbdiscount->id)
                @method('put')
            @endif
            <div class="modal-body">
                ...
                <div class="col-md-12 mb-2">
                    ...
                    <input type="text" class="form-control" name="user" id="user"
                        value="{{ $tbdiscount->user }}" readonly>
                </div> <?php } ?>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.formtbdiscount').submit(function(e) {
            const form = $(this)
            e.preventDefault();
            $.ajax({
                type: "POST",
