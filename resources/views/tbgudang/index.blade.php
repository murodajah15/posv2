...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-gudang" class="table table-bordered table-hover table-sm tbl-gudang">
                            {{-- <table id="tbl-gudang" class="table table-bordered table-striped tbl-gudang"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-gudang').DataTable({
                    ajax: "{{ route('tbgudangajax') }}",
                        ...
                        // },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                return `<div class="btn-group" role="group">
                                            <button id="btnGroupDrop1" type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false" data-boundary="window">
                                                Pilih Aksi
                                            </button>
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_gudang').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_gudang').html(data);
