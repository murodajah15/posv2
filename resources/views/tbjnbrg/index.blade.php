...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-jnbrg" class="table table-bordered table-hover table-sm tbl-jnbrg">
                            {{-- <table id="tbl-jnbrg" class="table table-bordered table-striped tbl-jnbrg"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-jnbrg').DataTable({
                    ajax: "{{ route('tbjnbrgajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_jnbrg').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_jnbrg').html(data);
