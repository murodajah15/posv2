...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-jnkeluar" class="table table-bordered table-hover table-sm tbl-jnkeluar">
                            {{-- <table id="tbl-jnkeluar" class="table table-bordered table-striped tbl-jnkeluar"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-jnkeluar').DataTable({
                    ajax: "{{ route('tbjnkeluarajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_jnkeluar').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_jnkeluar').html(data);
