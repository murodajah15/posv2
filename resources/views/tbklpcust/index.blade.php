...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-klpcust" class="table table-bordered table-hover table-sm tbl-klpcust">
                            {{-- <table id="tbl-klpcust" class="table table-bordered table-striped tbl-klpcust"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-klpcust').DataTable({
                    ajax: "{{ route('tbklpcustajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_klpcust').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_klpcust').html(data);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    ...
                                    // .then(function() {
                                    //     window.location.href = '/tbklpcust';
                                    // });
                                }
                            },
                            error: function(xhr, ajaxOptions, thrownError) {
