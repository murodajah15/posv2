...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        <form action="{{ $action }}" method="post" class="formtbklpcust">
            @csrf
            @if ($tbklpcust->id)
                @method('put')
            @endif
...
<script>
    ...
    $(document).ready(function() {
        $('.formtbklpcust').submit(function(e) {
            const form = $(this)
            e.preventDefault();
            $.ajax({
                type: "POST",
