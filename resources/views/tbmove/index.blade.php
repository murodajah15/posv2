...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-move" class="table table-bordered table-hover table-sm tbl-move">
                            {{-- <table id="tbl-move" class="table table-bordered table-striped tbl-move"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-move').DataTable({
                    ajax: "{{ route('tbmoveajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_move').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_move').html(data);
