...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-multiprc" class="table table-bordered table-hover table-sm tbl-multiprc">
                            {{-- <table id="tbl-multiprc" class="table table-bordered table-striped tbl-multiprc"> --}}
                            <thead>
                                <tr>
    ...
    <div class="modal fade" id="modalmultiprc" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <div class="modal fade" id="modalcaritbcustomer" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-multiprc').DataTable({
                    ajax: "{{ route('tbmultiprcajax') }}",
                    ...
                    //         <a href="#${row.id}"><button onclick="editmultiprc(${row.id})" class='btn btn-sm btn-primary' href='javascript:void(0)' <?= $pakai == 1 ? '' : 'disabled' ?>><i class='fa fa-edit'></i></button></a>`;
                            ...
                            render: function(data, type, row, meta) {
                                return `<div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <li><a class="dropdown-item <?= $pakai == 1 ? '' : 'disabled' ?>" onclick="editmultiprc(${row.id})" href="#" readonly><i class='fa fa-edit'"></i> Edit</a></li>
                                            </ul>
                                        </div>`;
        ...
        function editmultiprc(id) {
            $.ajax({
                type: "get",
                url: `{{ url('inputmultiprc') }}`,
                dataType: "json",
                data: {
                    id: id,
                    _method: "GET",
                ...
                success: function(response) {
                    if (response.data) {
                        // console.log(response.data);
                        $('#modalmultiprc').html(response.body);
