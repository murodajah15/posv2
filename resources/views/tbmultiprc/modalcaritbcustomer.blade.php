                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($tbcustomer as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbbrang();">
                                            <?= $row->kode ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbbrang();">
                                            <?= $row->nama ?></td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbbrang();">
...
<script>
    ...
    function post_data_tbbrang() {
        ...
        tbody.onclick = function(e) {
            ...
            $('#kdcustomersalin').val(((dt_split[1]).replace("--separator--", "")).trim());
            $('#nmcustomersalin').val(((dt_split[2]).replace("--separator--", "")).trim());
            $('#modalcaritbcustomer').modal('hide');
            $('#modalmultiprc').modal('show');
            $('#kdcustomersalin').focus();
        };
    }
</script>
