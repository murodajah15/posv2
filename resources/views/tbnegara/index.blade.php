...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-negara" class="table table-bordered table-hover table-sm tbl-negara">
                            {{-- <table id="tbl-negara" class="table table-bordered table-striped tbl-negara"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-negara').DataTable({
                    ajax: "{{ route('tbnegaraajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_negara').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_negara').html(data);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    ...
                                    //     icon: "error"
                                    // })
                                    toastr.errorr('Data gagal dihapus')
                                } else {
                                    // swal({
