    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-sales" class="table table-bordered table-hover table-sm tbl-sales">
                            {{-- <table id="tbl-sales" class="table table-bordered table-striped tbl-sales"> --}}
                            <thead>
                                <tr>
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_sales').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_sales').html(data);
