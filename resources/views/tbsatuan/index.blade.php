    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-satuan" class="table table-bordered table-hover table-sm tbl-satuan">
                            {{-- <table id="tbl-satuan" class="table table-bordered table-striped tbl-satuan"> --}}
                            <thead>
                                <tr>
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_satuan').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_satuan').html(data);
