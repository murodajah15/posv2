    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-supplier" class="table table-bordered table-hover table-sm tbl-supplier">
                            {{-- <table id="tbl-supplier" class="table table-bordered table-striped tbl-supplier"> --}}
                            <thead>
                                <tr>
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_supplier').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_supplier').html(data);
