...
<div class="modal-dialog" style="max-width: 60%;">
    <div class="modal-content">
        ...
        @endif --}}
        <form action="{{ $action }}" method="post" class="formtbsupplier">
            @csrf
            @if ($tbsupplier->id)
                @method('put')
            @endif
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea rows='3' class='form-control form-control-sm' name='alamat' id='alamat'
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>{{ $tbsupplier->alamat }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Kota</td>
                                        <td> <input type='text' class='form-control form-control-sm' name='kota'
                                                id='kota' value="{{ $tbsupplier->kota }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> <input type='text' class='form-control form-control-sm' name='kodepos'
                                                id='kodepos' value="{{ $tbsupplier->kodepos }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class='input-group'><input type='text'
                                                    ...
                                                    value="{{ $tbsupplier->telp1 }}"
                                                    {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                                <input type='text' class='form-control form-control-sm'
                                                    width='50%' name='telp2' value="{{ $tbsupplier->telp2 }}"
                                                    {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                            </div>
                                        </td>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type='text' class='form-control form-control-sm'
                                                ...
                                                value="{{ $tbsupplier->contact_person }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type='text' class='form-control form-control-sm' name='user'
                                                id='user' value="{{ $tbsupplier->user }}" readonly>
                                        </td>
                                    </tr>
                                    <?php } ?>
                            </table>
