...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-terima" class="table table-bordered table-hover table-sm tbl-terima">
                            {{-- <table id="so" class="table table-bordered table-striped so"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="120">No.Penerimaan</th>
                                    <th width="80">Tanggal</th>
                                    <th width="450">Referensi</th>
    ...
    <script>
        ...
        function reload_table() {
            $(function() {
                var table = $('.tbl-terima').DataTable({
                    ajax: "{{ route('terimaajax') }}",
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.noterima}</a>`;
                            }
                        },
                        {
                            data: 'tglterima',
                                ...
                                if (row.batal == 'Y') {
                                    ...
                                    if (row.proses == 'Y') {
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <li><a class="dropdown-item <?= $edit == 1 ? '' : 'disabled' ?>" onclick="input_terimad(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Detail</a></li>
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.sukses == false) {
                                    toastr.warning(
                                        'Data gagal di proses (total masih 0 / sudah closing)')
                                } else {
                                    reload_table();
        ...
        function input_terimad(id) {
            $.ajax({
                type: "get",
                url: `{{ url('terimainputterimad') }}`,
                dataType: "json",
                data: {
                    id: id,
                    methode: "get",
