    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' Detail : ' . $terima->noterima }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            <form action="{{ $action }}" method="post" class="formeditdetail">
                ...
                @endif
                <?php $tgl = date('Y-m-d'); ?>
                <input type="hidden" class="form-control-sm" name="tglterima" id="tglterima"
                    value="{{ $terima->tglterima }}">
                <input type="hidden" class="form-control-sm" name="id" id="id" value="{{ $terimad->id }}">
                <input type="hidden" class="form-control-sm" name="username" id="username"
                    value="{{ $session->get('username') }}">
                <input type="hidden" class="form-control-sm" name="noterima" id="noterima"
                    value="{{ $terima->noterima }}">
                <input type="hidden" class="form-control-sm" name="noterimad" id="noterimad"
                    value="{{ $terimad->noterima }}">
                <div class='col-md-12'>
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        ...
                        <td><input type="text" class='form-control form-control-sm' id='qty' name='qty'
                                ...
                                onblur="hit_subtotal()" value="{{ $terimad->qty }}"></td>
                        {{-- @if ($kunci_harga_terima == 'Y')
                            <td><input type="text" class='form-control form-control-sm' id='harga_beli'
                                    name='harga' style='width: 7em' value="{{ $terimad->harga }}" readonly></td>
                        @else --}}
                        <td><input type="text" class='form-control form-control-sm' id='harga_beli' name='harga'
                                ...
                                onblur="hit_subtotal()" value="{{ $terimad->harga }}"></td>
                        {{-- @endif --}}
                        <td><input type="text" class='form-control form-control-sm' id='discount' name='discount'
                                ...
                                value="{{ $terimad->discount }}">
                        </td>
                        <td><input type="text" class='form-control form-control-sm' id='subtotal' name='subtotal'
                                style='width: 10em;text-align:right;' value="{{ $terimad->subtotal }}" readonly>
                        </td>
                    </table>
            </form>
            <div class="row">
