...
@section('content')
    ...
    <script>
        ...
        function reload_table() {
                ...
                $('.tbl-user').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            // data: null,
                            render: function(data, type, row, meta) {
                                return `<a href="#" onclick="detail(${row.id})">${row.username}</a>`;
                            }
                        },
                        {
                            data: 'email',
                            ...
                            render: function(data, type, row, meta) {
                                return `<div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <li><a class="dropdown-item <?= $pakai == 1 ? '' : 'disabled' ?>" onclick="akses(${row.id})" href="#" readonly><i class='fa fa-universal-access'"></i> Akses</a></li>
            ...
            $('.btnreload').html('<i class="fa fa-spinner"></i>');
        }
